...
$CC -Wall main.c load-object.c jit.o ../lib-func/string.c -o l1vm -lm -ldl -lpthread -lasmjit -lSDL2 -lSDL2_gfx -lSDL2_image -lSDL2_ttf -Os -fomit-frame-pointer -g -Wl,--export-dynamic
