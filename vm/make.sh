...
$CC -Wall -Wextra main.c load-object.c debugger.c ../lib-func/string.c ../lib-func/code_datasize.c -o l1vm -L/usr/local/lib -lstdc++ -lm -ldl -lpthread -lasmjit -ll1vm-jit -O2 -fomit-frame-pointer -g -Wl,--export-dynamic
