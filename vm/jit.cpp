		...
		switch (code[i])
        {
			...
			case DIVI:
				...
				if (r1_i == -1)
				{
					...
					a.mov (R8, asmjit::x86::qword_ptr (RSI, OFFSET(r1)));
				...
				if (r2_i == -1)
				{
					a.mov (R9, asmjit::x86::qword_ptr (RSI, OFFSET(r1)));
			...
			case DIVD:
				...
				else
				{
					...
					{
						case 0:
							a.movsd (asmjit::x86::xmm1, asmjit::x86::xmm0);
							break;
