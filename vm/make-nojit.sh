...
if clang -Wall main.c load-object.c ../lib-func/string.c -o l1vm-nojit -lm -ldl -lpthread -lstdc++ -lSDL -lSDL_gfx -lSDL_image -lSDL_ttf -O2 -g -fomit-frame-pointer -Wl,--export-dynamic; then
	exit 0
else
	exit 1
fi
