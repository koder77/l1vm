...
if $CC -Wall -Wextra main.c load-object.c debugger.c ../lib-func/string.c ../lib-func/code_datasize.c ../lib-func/memory_bounds.c -o l1vm-nojit -lm -ldl -lpthread -O2 -g -fomit-frame-pointer -I/usr/include/SDL -Wl,--export-dynamic; then
	exit 0
else
	exit 1
fi
