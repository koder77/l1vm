    ...
    if (float_index_res >= MAX_FLOAT_NUM || float_index_res < 0)
{
    ...
    sp = stpopi ((U1 *) &lngamma, sp, sp_top);
    if (sp == NULL)
        {
        printf ("gmp_lngamma_float: ERROR: stack corrupt!\n");
        return (NULL);
    ...
    if (float_index_res >= MAX_FLOAT_NUM || float_index_res < 0)
{
    ...
    sp = stpopi ((U1 *) &bessely0, sp, sp_top);
    if (sp == NULL)
        {
        printf ("gmp_bessely0_float: ERROR: stack corrupt!\n");
        return (NULL);
    ...
    if (float_index_res >= MAX_FLOAT_NUM || float_index_res < 0)
{
    ...
    sp = stpopi ((U1 *) &bessely1, sp, sp_top);
    if (sp == NULL)
        {
        printf ("gmp_bessely1_float: ERROR: stack corrupt!\n");
        return (NULL);
    ...
    if (float_index_res >= MAX_FLOAT_NUM || float_index_res < 0)
{
    ...
    sp = stpopi ((U1 *) &rec_sqrt, sp, sp_top);
    if (sp == NULL)
        {
        printf ("gmp_rec_sqrt_float: ERROR: stack corrupt!\n");
        return (NULL);
    ...
    if (float_index_res >= MAX_FLOAT_NUM || float_index_res < 0)
{
    ...
    sp = stpopi ((U1 *) &digamma, sp, sp_top);
    if (sp == NULL)
        {
        printf ("gmp_digamma_float: ERROR: stack corrupt!\n");
        return (NULL);
    ...
    if (float_index_res >= MAX_FLOAT_NUM || float_index_res < 0)
{
    ...
    sp = stpopi ((U1 *) &rint_ceil, sp, sp_top);
    if (sp == NULL)
        {
        printf ("gmp_rint_ceil_float: ERROR: stack corrupt!\n");
        return (NULL);
    ...
    if (float_index_res >= MAX_FLOAT_NUM || float_index_res < 0)
{
    ...
    sp = stpopi ((U1 *) &rint_floor, sp, sp_top);
    if (sp == NULL)
        {
        printf ("gmp_rint_floor_float: ERROR: stack corrupt!\n");
        return (NULL);
    ...
    if (float_index_res >= MAX_FLOAT_NUM || float_index_res < 0)
{
    ...
    sp = stpopi ((U1 *) &rint_round, sp, sp_top);
    if (sp == NULL)
        {
        printf ("gmp_rint_round_float: ERROR: stack corrupt!\n");
        return (NULL);
    ...
    if (float_index_res >= MAX_FLOAT_NUM || float_index_res < 0)
{
    ...
    sp = stpopi ((U1 *) &rint_trunc, sp, sp_top);
    if (sp == NULL)
        {
        printf ("gmp_rint_trunc_float: ERROR: stack corrupt!\n");
        return (NULL);
    ...
    if (float_index_res >= MAX_FLOAT_NUM || float_index_res < 0)
{
    ...
    sp = stpopi ((U1 *) &remainder, sp, sp_top);
    if (sp == NULL)
        {
        printf ("gmp_remainder_float: ERROR: stack corrupt!\n");
        return (NULL);
    ...
    if (float_index_res >= MAX_FLOAT_NUM || float_index_res < 0)
{
    ...
    sp = stpopi ((U1 *) &nexttoward, sp, sp_top);
    if (sp == NULL)
        {
        printf ("gmp_nexttoward_float: ERROR: stack corrupt!\n");
        return (NULL);
    ...
    if (float_index_res >= MAX_FLOAT_NUM || float_index_res < 0)
{
    ...
    sp = stpopi ((U1 *) &nextabove, sp, sp_top);
    if (sp == NULL)
        {
        printf ("gmp_nextabove_float: ERROR: stack corrupt!\n");
        return (NULL);
    ...
    if (float_index_res >= MAX_FLOAT_NUM || float_index_res < 0)
{
    ...
    sp = stpopi ((U1 *) &nextbelow, sp, sp_top);
    if (sp == NULL)
        {
        printf ("gmp_nextbelow_float: ERROR: stack corrupt!\n");
        return (NULL);
