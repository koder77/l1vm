    ...
    switch (selected)
    {
        ...
        case GADGET_MENU_DOWN:
            if (! cycle->menu)
            {
                ...
                bmap_copy = SDL_CreateRGBSurface (SDL_SWSURFACE | SDL_SRCALPHA, cycle->menu_x2 - cycle->menu_x + 1, cycle->menu_y2 - cycle->menu_y + 1, video_bpp, rmask, gmask, bmask, amask);
                if (bmap_copy == NULL)
                {
                ...
                screen[BLITSCREEN].bmap = SDL_CreateRGBSurface (SDL_SWSURFACE | SDL_SRCALPHA, cycle->menu_x2 - cycle->menu_x + 1, cycle->menu_y2 - cycle->menu_y + 1, video_bpp, rmask, gmask, bmask, amask);
            ...
            case SDL_KEYDOWN:
                ...
                switch (key)
                {
                    ...
                    default:
                        ...
                        {
                                strinsertchar ((char *) string_buf, (char *) string->value, event.key.keysym.unicode, string->insert_pos);
                                strcpy ((char *) string->value, (char *) string_buf);
