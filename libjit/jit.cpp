...
// Generates code for x86 64 bit. The double floating point number opcodes use
// SSE opcodes.
...
extern "C" int jit_compiler(U1 *code, U1 *data, S8 *jumpoffs ALIGN,
                            S8 *regi ALIGN, F8 *regd ALIGN, U1 *sp, U1 *sp_top,
                            U1 *sp_bottom, S8 start ALIGN, S8 end ALIGN,
                            struct JIT_code *JIT_code, S8 JIT_code_ind ALIGN,
                            S8 code_size ALIGN) {
  S8 i ALIGN;
  S8 j ALIGN;
  S8 l ALIGN;
  ...
  while (i <= end) {
    ...
    if (offset == 0) {
      ...
      printf(
          "FATAL error: JIT compiler: setting jump offset failed! opcode: %i\n",
          code[i]);
      return (1);
    }
    ...
    case DIVD:
...
#if DEBUG
      printf(
          "JIT-compiler: double opcode: %i: R1 = %lli, R2 = %lli, R3 = %lli\n",
          code[i], r1, r2, r3);
      ...
      if (r2_d == -1) {
        ...
        if (r3_d != -1) {
          switch (r3_d) {
          case 2:
            a.movsd(asmjit::x86::xmm2, asmjit::x86::qword_ptr(RDI, OFFSET(r2)));
            break;
          ...
          case 4:
            a.movsd(asmjit::x86::xmm4, asmjit::x86::qword_ptr(RDI, OFFSET(r2)));
            break;
          ...
          case 6:
            a.movsd(asmjit::x86::xmm6, asmjit::x86::qword_ptr(RDI, OFFSET(r2)));
            break;

          case 7:
            a.movsd(asmjit::x86::xmm7, asmjit::x86::qword_ptr(RDI, OFFSET(r2)));
            break;

          case 8:
            a.movsd(asmjit::x86::xmm8, asmjit::x86::qword_ptr(RDI, OFFSET(r2)));
            break;

          case 9:
            a.movsd(asmjit::x86::xmm9, asmjit::x86::qword_ptr(RDI, OFFSET(r2)));
            break;

          case 10:
            a.movsd(asmjit::x86::xmm10,
                    asmjit::x86::qword_ptr(RDI, OFFSET(r2)));
            break;

          case 11:
            a.movsd(asmjit::x86::xmm11,
                    asmjit::x86::qword_ptr(RDI, OFFSET(r2)));
            break;

          case 12:
            a.movsd(asmjit::x86::xmm12,
                    asmjit::x86::qword_ptr(RDI, OFFSET(r2)));
            break;

          case 13:
            a.movsd(asmjit::x86::xmm13,
                    asmjit::x86::qword_ptr(RDI, OFFSET(r2)));
            break;

          case 14:
            a.movsd(asmjit::x86::xmm14,
                    asmjit::x86::qword_ptr(RDI, OFFSET(r2)));
            break;

          case 15:
            a.movsd(asmjit::x86::xmm15,
                    asmjit::x86::qword_ptr(RDI, OFFSET(r2)));
            break;
          }
        ...
        case 2:
          switch (code[i]) {
          case ADDD:
            a.addsd(asmjit::x86::xmm0, asmjit::x86::xmm2);
            break;

          case SUBD:
            a.subsd(asmjit::x86::xmm0, asmjit::x86::xmm2);
            break;

          case MULD:
            a.mulsd(asmjit::x86::xmm0, asmjit::x86::xmm2);
            break;

          case DIVD:
            a.divsd(asmjit::x86::xmm0, asmjit::x86::xmm2);
            break;
          }
          break;
        ...
        case 3:
          switch (code[i]) {
          case ADDD:
            a.addsd(asmjit::x86::xmm0, asmjit::x86::xmm3);
            break;

          case SUBD:
            a.subsd(asmjit::x86::xmm0, asmjit::x86::xmm3);
            break;

          case MULD:
            a.mulsd(asmjit::x86::xmm0, asmjit::x86::xmm3);
            break;

          case DIVD:
            a.divsd(asmjit::x86::xmm0, asmjit::x86::xmm3);
            break;
          }
          break;
        ...
        case 4:
          switch (code[i]) {
          case ADDD:
            a.addsd(asmjit::x86::xmm0, asmjit::x86::xmm4);
            break;

          case SUBD:
            a.subsd(asmjit::x86::xmm0, asmjit::x86::xmm4);
            break;

          case MULD:
            a.mulsd(asmjit::x86::xmm0, asmjit::x86::xmm4);
            break;

          case DIVD:
            a.divsd(asmjit::x86::xmm0, asmjit::x86::xmm4);
            break;
          }
          break;
        ...
        case 5:
          switch (code[i]) {
          case ADDD:
            a.addsd(asmjit::x86::xmm0, asmjit::x86::xmm5);
            break;

          case SUBD:
            a.subsd(asmjit::x86::xmm0, asmjit::x86::xmm5);
            break;

          case MULD:
            a.mulsd(asmjit::x86::xmm0, asmjit::x86::xmm5);
            break;

          case DIVD:
            a.divsd(asmjit::x86::xmm0, asmjit::x86::xmm5);
            break;
          }
          break;
        ...
        case 6:
          switch (code[i]) {
          case ADDD:
            a.addsd(asmjit::x86::xmm0, asmjit::x86::xmm6);
            break;

          case SUBD:
            a.subsd(asmjit::x86::xmm0, asmjit::x86::xmm6);
            break;

          case MULD:
            a.mulsd(asmjit::x86::xmm0, asmjit::x86::xmm6);
            break;

          case DIVD:
            a.divsd(asmjit::x86::xmm0, asmjit::x86::xmm6);
            break;
          }
          break;
        ...
        case 7:
          switch (code[i]) {
          case ADDD:
            a.addsd(asmjit::x86::xmm0, asmjit::x86::xmm7);
            break;

          case SUBD:
            a.subsd(asmjit::x86::xmm0, asmjit::x86::xmm7);
            break;

          case MULD:
            a.mulsd(asmjit::x86::xmm0, asmjit::x86::xmm7);
            break;

          case DIVD:
            a.divsd(asmjit::x86::xmm0, asmjit::x86::xmm7);
            break;
          }
          break;
        ...
        case 8:
          switch (code[i]) {
          case ADDD:
            a.addsd(asmjit::x86::xmm0, asmjit::x86::xmm8);
            break;

          case SUBD:
            a.subsd(asmjit::x86::xmm0, asmjit::x86::xmm8);
            break;

          case MULD:
            a.mulsd(asmjit::x86::xmm0, asmjit::x86::xmm8);
            break;

          case DIVD:
            a.divsd(asmjit::x86::xmm0, asmjit::x86::xmm8);
            break;
          }
          break;
        ...
        case 9:
          switch (code[i]) {
          case ADDD:
            a.addsd(asmjit::x86::xmm0, asmjit::x86::xmm9);
            break;

          case SUBD:
            a.subsd(asmjit::x86::xmm0, asmjit::x86::xmm9);
            break;

          case MULD:
            a.mulsd(asmjit::x86::xmm0, asmjit::x86::xmm9);
            break;

          case DIVD:
            a.divsd(asmjit::x86::xmm0, asmjit::x86::xmm9);
            break;
          }
          break;
        ...
        case 10:
          switch (code[i]) {
          case ADDD:
            a.addsd(asmjit::x86::xmm0, asmjit::x86::xmm10);
            break;

          case SUBD:
            a.subsd(asmjit::x86::xmm0, asmjit::x86::xmm10);
            break;

          case MULD:
            a.mulsd(asmjit::x86::xmm0, asmjit::x86::xmm10);
            break;

          case DIVD:
            a.divsd(asmjit::x86::xmm0, asmjit::x86::xmm10);
            break;
          }
          break;
        ...
        case 11:
          switch (code[i]) {
          case ADDD:
            a.addsd(asmjit::x86::xmm0, asmjit::x86::xmm11);
            break;

          case SUBD:
            a.subsd(asmjit::x86::xmm0, asmjit::x86::xmm11);
            break;

          case MULD:
            a.mulsd(asmjit::x86::xmm0, asmjit::x86::xmm11);
            break;

          case DIVD:
            a.divsd(asmjit::x86::xmm0, asmjit::x86::xmm11);
            break;
          }
          break;
        ...
        case 12:
          switch (code[i]) {
          case ADDD:
            a.addsd(asmjit::x86::xmm0, asmjit::x86::xmm12);
            break;

          case SUBD:
            a.subsd(asmjit::x86::xmm0, asmjit::x86::xmm12);
            break;

          case MULD:
            a.mulsd(asmjit::x86::xmm0, asmjit::x86::xmm12);
            break;

          case DIVD:
            a.divsd(asmjit::x86::xmm0, asmjit::x86::xmm12);
            break;
          }
          break;
        ...
        case 13:
          switch (code[i]) {
          case ADDD:
            a.addsd(asmjit::x86::xmm0, asmjit::x86::xmm13);
            break;

          case SUBD:
            a.subsd(asmjit::x86::xmm0, asmjit::x86::xmm13);
            break;

          case MULD:
            a.mulsd(asmjit::x86::xmm0, asmjit::x86::xmm13);
            break;

          case DIVD:
            a.divsd(asmjit::x86::xmm0, asmjit::x86::xmm13);
            break;
          }
          break;
        ...
        case 14:
          switch (code[i]) {
          case ADDD:
            a.addsd(asmjit::x86::xmm0, asmjit::x86::xmm14);
            break;

          case SUBD:
            a.subsd(asmjit::x86::xmm0, asmjit::x86::xmm14);
            break;

          case MULD:
            a.mulsd(asmjit::x86::xmm0, asmjit::x86::xmm14);
            break;

          case DIVD:
            a.divsd(asmjit::x86::xmm0, asmjit::x86::xmm14);
            break;
          }
          break;
        ...
        case 15:
          switch (code[i]) {
          case ADDD:
            a.addsd(asmjit::x86::xmm0, asmjit::x86::xmm15);
            break;

          case SUBD:
            a.subsd(asmjit::x86::xmm0, asmjit::x86::xmm15);
            break;

          case MULD:
            a.mulsd(asmjit::x86::xmm0, asmjit::x86::xmm15);
            break;

          case DIVD:
            a.divsd(asmjit::x86::xmm0, asmjit::x86::xmm15);
            break;
          }
          break;
        }
    ...
    case BANDI:
      ...
      a.movq(asmjit::x86::mm0,
             asmjit::x86::qword_ptr(RSI, OFFSET(r1))); /* r1v */
      a.movq(asmjit::x86::mm1,
             asmjit::x86::qword_ptr(RSI, OFFSET(r2))); /* r2v */
    ...
    case EQD:
      ...
      a.movsd(asmjit::x86::xmm0,
              asmjit::x86::qword_ptr(RDI, OFFSET(r1))); /* r1v */
      a.movsd(asmjit::x86::xmm1,
              asmjit::x86::qword_ptr(RDI, OFFSET(r2))); /* r2v */
