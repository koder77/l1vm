...
(setq l1vm-font-lock-keywords
      (let* (
            ...
            (x-functions '("func" "funcend" "ASM" "ASM_END" "optimize-if-off" "optimize-if" "no-var-pull-off" "no-var-pull-on" "reset-reg" "#func" "#define" "#var" "#include"))
