...
(setq l1vm-font-lock-keywords
      (let* (
            ...
            (x-functions '("#func" "#define" "#var" "#include" "func" "funcend" "ASM" "ASM_END" "optimize-if-off" "optimize-if" "no-var-pull-off" "no-var-pull-on" "reset-reg" "nested-code-off" "objectend" "object"))
