...
#define LABELLEN				64
    ...
    #define MAXSTRLEN		2048	    // MAX LENGTH for maximum string size for static allocation
#endif
...
#define VM_VERSION_STR "3.6.6"
#define MOTTO_STR "Level 1 VM - supernova"
