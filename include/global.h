...
#if __CYGWIN__ || __MACH__ || __OpenBSD__ || __FreeBSD__ || __HAIKU__
	#define __linux__	1
#endif
...
// info strings:
#define COPYRIGHT_STR " 2023/summer reloaded (C) 2017-2023 Stefan Pietzonke - software research"
#define VM_VERSION_STR		"2.6.2"		// version number
#define MOTTO_STR "clear sky"
